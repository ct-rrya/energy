...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #FFF4E1 0%, #FFEFD5 100%)' }}>
      {/* Navigation */}
      <Navigation />
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-24">
        <div className="text-center">
          {/* Badge */}
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold" style={{
            background: '#89D7B7',
            color: '#1A312C',
            borderColor: '#428475'
          }}>
          ...
          {/* Headline */}
          <h2 className="mb-4 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl" style={{ color: '#1A312C' }}>
            EcoStep: IoT Piezoelectric
            <br />
            <span style={{ color: '#428475' }}>Energy Monitoring Dashboard</span>
          </h2>

          {/* Subheadline - Enhanced value proposition */}
          <p className="mx-auto mb-8 max-w-2xl text-lg sm:text-xl" style={{ color: '#1A312C', opacity: 0.8 }}>
            Real-time analytics and monitoring portal for authorized FSTLP administrators.
          ...
          <div className="hero-cta-group flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button
              ...
              className="hero-cta-button inline-flex items-center gap-2 rounded-lg px-8 py-4 text-base font-semibold text-white shadow-lg transition-all hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2"
              style={{ 
                background: '#1A312C',
                boxShadow: '0 10px 25px rgba(26, 49, 44, 0.3)'
              }}
              onMouseEnter={(e) => {
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.background = '#1A312C';
      ...
      <section className="border-t py-16 lg:py-24" style={{ 
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <button
              onClick={handleAccessDashboard}
              className="inline-flex items-center gap-2 rounded-lg px-8 py-4 text-base font-semibold text-white shadow-lg transition-all hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2"
              style={{ 
                background: '#428475',
                boxShadow: '0 10px 25px rgba(66, 132, 117, 0.3)'
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = '#2D7A5F';
                e.currentTarget.style.transform = 'translateY(-2px)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = '#428475';
      ...
      <section id="features" className="border-t bg-white py-16 lg:py-24" style={{ borderColor: 'rgba(26, 49, 44, 0.1)' }}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          {/* Section Header */}
          <div className="mb-12 text-center">
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="rounded-xl bg-white p-8 shadow-lg" style={{ 
            ...
            <div className="space-y-4 text-base leading-relaxed" style={{ color: '#1A312C', opacity: 0.8 }}>
              ...
              <p className="pt-2 text-sm" style={{ opacity: 0.7 }}>
      ...
      <footer className="border-t py-8 text-white" style={{ 
        background: '#1A312C',
        borderColor: 'rgba(137, 215, 183, 0.2)'
      }}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>
                Cebu Technological University - FSTLP
              </div>
            </div>
